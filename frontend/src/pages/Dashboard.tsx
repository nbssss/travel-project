...
const Dashboard = () => {
  ...
  const totalKm = mockRoutes.reduce((s, r) => s + r.distanceKm, 0).toFixed(1);
    ...
    <AppShell>
      <div className="container max-w-7xl py-8 md:py-12">
        ...
        <div className="mt-8 grid grid-cols-2 gap-px overflow-hidden rounded-xl border bg-hairline md:grid-cols-4" style={{ borderColor: "hsl(var(--hairline))" }}>
          ...
          <BigStat n={totalKm} unit="km" label="łącznie dystans" />
          <BigStat n={totalAsc.toLocaleString("pl-PL")} unit="m" label="suma podejść" />
