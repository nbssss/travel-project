...
const morskieOko: Route = {
  ...
  path: [
    [49.2701, 20.0805], [49.2680, 20.0830], [49.2645, 20.0865],
    [49.2602, 20.0875], [49.2560, 20.0848], [49.2520, 20.0810],
    [49.2486, 20.0820], [49.2450, 20.0858], [49.2418, 20.0884],
    [49.2390, 20.0884], [49.2367, 20.0880],
  ],
  pois: [
...
const dolinaKoscieliska: Route = {
  ...
  path: [
    [49.2767, 19.8732], [49.2724, 19.8728], [49.2680, 19.8704],
    [49.2640, 19.8682], [49.2602, 19.8666], [49.2566, 19.8645],
  ],
  pois: [
...
const giewont: Route = {
  ...
  path: [
    [49.2992, 19.9492], [49.2940, 19.9480], [49.2880, 19.9472],
    [49.2820, 19.9460], [49.2772, 19.9438], [49.2735, 19.9423],
  ],
  pois: [
